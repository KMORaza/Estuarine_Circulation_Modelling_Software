...
namespace EstuarineCirculationModeling
{
    public partial class Form1 : Form
    {
        ...
        private AsymmTidalMix asymmTidalMix;
        private TotalVariationDiminishing tvdSim;
        private double riverScalarConcentration = 1.0;
        ...
        public Form1()
        {
            ...
            asymmTidalMix = new AsymmTidalMix();
            tvdSim = new TotalVariationDiminishing();
        ...
        private void startButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                model.SalinityOcean = Math.Max(0.1, Math.Min(40.0, salinityOcean));
                model.TemperatureOcean = Math.Max(0.1, Math.Min(40.0, temperatureOcean));
        ...
        private void useRANSSolverCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            largeEddyButton.Enabled = true;
            lbLesButton.Enabled = true;
            tidalStrainButton.Enabled = true;
            satButton.Enabled = true;
            compForcingButton.Enabled = true;
            tamButton.Enabled = true;
            atmButton.Enabled = true;
            tvdButton.Enabled = true;
            mfstButton.Enabled = true; // Added for MFST
        ...
        {
            asymmTidalMix.ShowAsymmTidalMixWindow();
        }

        private void tvdButton_Click(object sender, EventArgs e)
        {
            tvdSim.ShowTVDWindow();
        }

        private void mfstButton_Click(object sender, EventArgs e)
        {
            MultiFracSedimentTransp.ShowMFSTWindow();
        }
