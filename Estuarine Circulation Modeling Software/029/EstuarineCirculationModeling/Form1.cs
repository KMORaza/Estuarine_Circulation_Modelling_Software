...
namespace EstuarineCirculationModeling
{
    public partial class Form1 : Form
    {
        ...
        private TotalVariationDiminishing tvdSim; // Added for TVD
        ...
        public Form1()
        {
            ...
            tvdSim = new TotalVariationDiminishing(); // Initialize TVD
        ...
        private void useRANSSolverCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            atmButton.Enabled = true; // ATM button always enabled
            tvdButton.Enabled = true; // TVD button always enabled
