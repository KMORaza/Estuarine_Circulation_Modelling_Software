        ...
        private void VisualizationPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (analysisType == "Spectral Analysis")
            {
                if (visualizationPanel.Tag is SpectralData spectralData)
                {
                    ...
                    g.DrawString($"Power Spectral Density of {variableComboBox.SelectedItem} ({(isLogLog ? "Log-Log" : "Linear")}, {selectedWindowType} Window)", new Font("Verdana", 10F, FontStyle.Bold), Brushes.Black, margin, 10);
                    ...
                    g.DrawString("Frequency (Hz)", new Font("Verdana", 9F), Brushes.Black, xOrigin + plotWidth / 2 - 30, yOrigin + 20);
                    g.DrawString("PSD", new Font("Verdana", 9F), Brushes.Black, xOrigin - 40, yOrigin - plotHeight / 2 - 10, new StringFormat { FormatFlags = StringFormatFlags.DirectionVertical });
                    ...
                    foreach (var freq in new[] { (m2Freq, "M2"), (k1Freq, "K1") })
                    {
                        if (freq.Item1 <= maxFreq && freq.Item1 >= minFreq)
                        {
                            ...
                            g.DrawString(freq.Item2, new Font("Verdana", 8F), Brushes.Red, xPos + 2, yOrigin - plotHeight);
                        }
                    }

                    g.DrawLine(Pens.Blue, xOrigin + plotWidth - 60, 30, xOrigin + plotWidth - 40, 30);
                    g.DrawString("Power Spectral Density", new Font("Verdana", 8F), Brushes.Black, xOrigin + plotWidth - 100, 25);
                }
                else if (isAnalyzing)
                {
                    ...
                    g.DrawString($"Time Series: {variableComboBox.SelectedItem?.ToString() ?? "Value"}", new Font("Verdana", 10F, FontStyle.Bold), Brushes.Black, margin, 10);
                    g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin + plotWidth, yOrigin);
                    g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin, yOrigin - plotHeight);
                    g.DrawString("Time (s)", new Font("Verdana", 9F), Brushes.Black, xOrigin + plotWidth / 2 - 20, yOrigin + 20);
                    g.DrawString(variableComboBox.SelectedItem?.ToString() ?? "Value", new Font("Verdana", 9F), Brushes.Black, xOrigin - 40, yOrigin - plotHeight / 2 - 10, new StringFormat { FormatFlags = StringFormatFlags.DirectionVertical });
                    ...
                    g.DrawLine(Pens.Blue, xOrigin + plotWidth - 60, 30, xOrigin + plotWidth - 40, 30);
                    g.DrawString("Time Series", new Font("Verdana", 8F), Brushes.Black, xOrigin + plotWidth - 100, 25);
                    if (mixingEvents.Count > 0)
                    {
                        g.FillEllipse(Brushes.Red, xOrigin + plotWidth - 60, 40, 6, 6);
                        g.DrawString("Mixing Events", new Font("Verdana", 8F), Brushes.Black, xOrigin + plotWidth - 100, 40);
                    }
                }
            }
            else // EOF/POD Analysis
            {
                if (visualizationPanel.Tag is EOFData eofData)
                {
                    ...
                    if (variable == "Salinity")
                    {
                        ...
                        g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin + plotWidth, yOrigin);
                        g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin, yOrigin - plotHeight);
                        g.DrawString("X", new Font("Verdana", 9F), Brushes.Black, xOrigin + plotWidth / 2 - 10, yOrigin + 20);
                        g.DrawString("Y", new Font("Verdana", 9F), Brushes.Black, xOrigin - 30, yOrigin - plotHeight / 2 - 10, new StringFormat { FormatFlags = StringFormatFlags.DirectionVertical });
                        ...
                        g.DrawString("Value", new Font("Verdana", 8F), Brushes.Black, legendX, legendY - 20);
                        g.DrawString("Max", new Font("Verdana", 8F), Brushes.Black, legendX, legendY - 10);
                        g.DrawString("Min", new Font("Verdana", 8F), Brushes.Black, legendX, legendY + legendHeight);
                    }
                    else // Velocity Profile
                    {
                        const int depthLevels = 10;
                        ...
                        g.DrawString($"EOF Mode {modeIndex + 1} for Velocity Profile", new Font("Verdana", 10F, FontStyle.Bold), Brushes.Black, margin, 10);
                        g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin + plotWidth, yOrigin);
                        g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin, yOrigin - plotHeight);
                        g.DrawString("Velocity", new Font("Verdana", 9F), Brushes.Black, xOrigin + plotWidth / 2 - 20, yOrigin + 20);
                        g.DrawString("Depth", new Font("Verdana", 9F), Brushes.Black, xOrigin - 30, yOrigin - plotHeight / 2 - 10, new StringFormat { FormatFlags = StringFormatFlags.DirectionVertical });
                        ...
                        g.DrawLine(Pens.Blue, xOrigin + plotWidth - 60, 30, xOrigin + plotWidth - 40, 30);
                        g.DrawString("Velocity Profile", new Font("Verdana", 8F), Brushes.Black, xOrigin + plotWidth - 100, 25);
                    }
                }
            }
        }
        ...
        private void HeatmapPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (analysisType == "Spectral Analysis")
            {
                if (heatmapPanel.Tag is HeatmapData heatmapData)
                {
                    ...
                    g.DrawString($"Time-Frequency Heatmap of {variableComboBox.SelectedItem} ({(isLogLog ? "Log-Log" : "Linear")}, {selectedWindowType} Window)", new Font("Verdana", 10F, FontStyle.Bold), Brushes.Black, margin, 10);
                    g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin + plotWidth, yOrigin);
                    g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin, yOrigin - plotHeight);
                    g.DrawString("Time (s)", new Font("Verdana", 9F), Brushes.Black, xOrigin + plotWidth / 2 - 20, yOrigin + 20);
                    g.DrawString("Frequency (Hz)", new Font("Verdana", 9F), Brushes.Black, xOrigin - 40, yOrigin - plotHeight / 2 - 10, new StringFormat { FormatFlags = StringFormatFlags.DirectionVertical });
                    ...
                    foreach (var freq in new[] { (m2Freq, "M2"), (k1Freq, "K1") })
                    {
                        if (freq.Item1 <= maxFreq && freq.Item1 >= minFreq)
                        {
                            ...
                            g.DrawString(freq.Item2, new Font("Verdana", 8F), Brushes.Red, xOrigin + plotWidth - 20, yPos - 10);
                        }
                    }
                    ...
                    g.DrawString("Power", new Font("Verdana", 8F), Brushes.Black, legendX, legendY - 20);
                    g.DrawString(isLogLog ? "Log" : "Max", new Font("Verdana", 8F), Brushes.Black, legendX, legendY - 10);
                    g.DrawString("Min", new Font("Verdana", 8F), Brushes.Black, legendX, legendY + legendHeight);
                }
            }
            else // EOF/POD Analysis
            {
                if (heatmapPanel.Tag is EOFData eofData)
                {
                    ...
                    g.DrawLine(Pens.Black, xOrigin, yOrigin, xOrigin, yOrigin - plotHeight);
                    g.DrawString("Time (s)", new Font("Verdana", 9F), Brushes.Black, xOrigin + plotWidth / 2 - 20, yOrigin + 20);
                    g.DrawString("Coefficient", new Font("Verdana", 9F), Brushes.Black, xOrigin - 40, yOrigin - plotHeight / 2 - 10, new StringFormat { FormatFlags = StringFormatFlags.DirectionVertical });
                    ...
                    g.DrawLine(Pens.Blue, xOrigin + plotWidth - 60, 30, xOrigin + plotWidth - 40, 30);
                    g.DrawString("Temporal Coefficient", new Font("Verdana", 8F), Brushes.Black, xOrigin + plotWidth - 100, 25);
                }
            }
        }
        ...
        private void DrawGridAndTicks(Graphics g, float xOrigin, float yOrigin, float plotWidth, float plotHeight, double maxX, double maxY, bool isPowerSpectrum, int margin, bool isLogLog, double minFreq)
        {
            ...
            if (isPowerSpectrum && isLogLog)
            {
                ...
                for (double logX = Math.Ceiling(logMinFreq); logX <= logMaxFreq; logX += xTickInterval)
                {
                    ...
                    g.DrawString(label, new Font("Verdana", 8F), Brushes.Black, xPos - 15, yOrigin + 10);
                }
            }
            else
            {
            ...
            if (isPowerSpectrum && isLogLog)
            {
                ...
                for (double logY = Math.Ceiling(logMinY); logY <= logMaxY; logY += yTickInterval)
                {
                    ...
                    g.DrawString(label, new Font("Verdana", 8F), Brushes.Black, xOrigin - 40, yPos - 5);
                }
            }
            else
            {
