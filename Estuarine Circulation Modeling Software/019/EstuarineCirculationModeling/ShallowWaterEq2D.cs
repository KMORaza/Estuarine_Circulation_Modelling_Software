...
namespace EstuarineCirculationModeling
{
    public class ShallowWaterEq2D
    {
        ...
        private double riverDischarge, tidalAmplitude, tidalPeriod, windSpeed, windDirection, salinityGradient, waveHeight, stormSurgeAmplitude;
        ...
        public ShallowWaterEq2D(double length, double width, double depth, int nx, int ny,
            ...
            double windSpeed, double windDirection, double salinityGradient,
            double waveHeight, double stormSurgeAmplitude)
        {
