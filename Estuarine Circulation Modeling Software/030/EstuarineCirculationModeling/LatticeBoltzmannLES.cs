...
#pragma warning restore CS0414
        ...
        private void VisualizationPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (visualizationMode == "Velocity")
            {
                ...
                g.DrawString("Velocity", new Font("Verdana", 8), Brushes.Black, visualizationPanel.Width - 30, 100);
            }
            else if (visualizationMode == "Salinity")
            {
                ...
                g.DrawString("Salinity", new Font("Verdana", 8), Brushes.Black, visualizationPanel.Width - 30, 100);
            }
            else // Time-Averaged Velocity
            {
                ...
                g.DrawString("Time-Avg Velocity", new Font("Verdana", 8), Brushes.Black, visualizationPanel.Width - 30, 100);
            }
        }
        ...
        private void VorticityPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.DrawString(vortexColorMode, new Font("Verdana", 8), Brushes.Black, vorticityPanel.Width - 30, 100);
        }
